//26.	Write a program to show the highest scorer in a test out of three students who appeared in a exam.
// Use this pointer to refer to objects. 
...
int main()
{
student s1(1,"Aditi shukla",90), s2(2,"Ankita pandey",75), s3(3,"Ashi karan",95);
